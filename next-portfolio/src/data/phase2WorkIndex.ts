...
export const WORK_INDEX_PROJECTS: readonly WorkIndexProject[] = [
  ...
  },
  {
    ...
    premise:
      "A companion app for a handheld EKG device, designed across 25+ screens to reassure a person tracking their own heart health, not alarm them.",
...
export const REEL_PROJECTS = WORK_INDEX_PROJECTS;
export type ReelProject = WorkIndexProject;
